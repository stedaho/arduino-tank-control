...
* **Schalter** zur Aktivierung des Wartungsmodus an Pin 7
...
![Schaltplan](/docs/sketch-fritzing.png "Schaltplan")
...
* **Switch** to activate the maintenance mode at pin 7
...
![Circuit](/docs/sketch-fritzing.png "Circuit")
