...
unsigned int valueTableWhite[MAX_VALUES][2] {
  ...
  {(21 * HOUR + 20 * MINUTE) / 10, 900},
  {(21 * HOUR + 40 * MINUTE) / 10, 0}
};
...
unsigned int valueTableBlue[MAX_VALUES][2] {
  ...
  {(16 * HOUR + 30 * MINUTE) / 10, 50},
  {(16 * HOUR + 45 * MINUTE) / 10, 900},
  {(21 * HOUR +  0 * MINUTE) / 10, 900},
  {(21 * HOUR + 20 * MINUTE) / 10, 0},
  {(21 * HOUR + 59 * MINUTE + 50) / 10, 0},
  {(22 * HOUR +  0 * MINUTE) / 10, 30}
};
